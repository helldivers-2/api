...
namespace Helldivers.Models.ArrowHead.Summary;

/// <summary>
/// Similar to <see cref="GalaxyStats" />, but scoped to a specific planet.
/// </summary>
/// <param name="PlanetIndex">The <see cref="PlanetInfo.Index" /> for which planet these stats are.</param>
...
/// <param name="BugKills">The total amount of bugs killed since start of the season.</param>
...
/// <param name="Accurracy">A percentage indicating average accuracy of Helldivers.</param>
public sealed record PlanetStats(
    int PlanetIndex,
    ulong MissionsWon,
    ulong MissionsLost,
    ulong MissionTime,
