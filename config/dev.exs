...
config :helldivers_2, Helldivers2Web.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "NKfD+wO98ETWmddutVPxXsYfQiZnDP8EUXb7p94o/nia+SHPkrnMjvrAci002ASU",
  watchers: [
...
config :helldivers_2, Helldivers2Web.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"lib/helldivers_2_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :helldivers_2, dev_routes: true
