defmodule Helldivers2Web do
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {Helldivers2Web.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      import Helldivers2Web.CoreComponents
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: Helldivers2Web.Router,
        statics: Helldivers2Web.static_paths()
    end
  end
